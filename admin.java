...
public class admin extends JFrame implements ActionListener {
    ...
    admin(){
        ...
        label1.setBounds(70,250,120,120);
        add(label1);
        ...
        label2.setBounds(70,400,120,120);
        add(label2);

        ImageIcon imageIcon3 = new ImageIcon(ClassLoader.getSystemResource("icons/logogif.gif"));
        ...
        label3.setBounds(800,100,400,400);
        add(label3);
