...
public class Reception extends JFrame{
    Reception(){
        ...
        ImageIcon i111 = new ImageIcon(ClassLoader.getSystemResource("icons/logogif.gif"));
        ...
        label11.setBounds(300,150,400,400);
        panel.add(label11);

        ImageIcon i11 = new ImageIcon(ClassLoader.getSystemResource("icons/logo.png"));
        Image i2 = i11.getImage().getScaledInstance(160,120, Image.SCALE_DEFAULT);
        ImageIcon imageIcon11 = new ImageIcon(i2);
        JLabel label1 = new JLabel(imageIcon11);
        label1.setBounds(50,510,160,120);
        panel1.add(label1);
